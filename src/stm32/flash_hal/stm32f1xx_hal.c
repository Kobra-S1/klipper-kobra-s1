...
/* Provide RCC reset helpers when the RCC HAL header isn't pulled in */
#ifndef __HAL_RCC_APB1_FORCE_RESET
...
#if !defined(__HAL_RCC_AHB_FORCE_RESET) && (defined(STM32F105xC) || defined(STM32F107xC))
